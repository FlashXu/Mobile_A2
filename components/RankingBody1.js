...
showToday() {
    ...
    if(this.state.showFriendsRanking) {
        ...
        this.setState({
            friendsRanking:[
                {Id:"123", totalDistance:6,avgSpeed:5,name:'Frend1',rank:'1'},
                {Id:"1234", totalDistance:6,avgSpeed:5,name:'Frend2',rank:'2'},
                {Id:"12345", totalDistance:6,avgSpeed:5,name:'Frend3',rank:'3'},
                {Id:"123456", totalDistance:6,avgSpeed:5,name:'Frend4',rank:'4'},
                {Id:"1234567", totalDistance:6,avgSpeed:5,name:'Frend5',rank:'5'},
            ]
        })
    } else {
        //show city ranking
