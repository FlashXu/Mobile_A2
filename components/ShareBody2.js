      ...
      if (id != null){
        ...
        getDBdata(url).then(function(res){
          ...
          for (let i = 0; i < moments_list.length; i++){
            ...
            var moment_comments = moment.comments;
            if (moment.comments.length > 0){
              for(let j = 0; j < moment.comments.length; j++){
                ...
                var user_comment = {};
                user_comment.date = moment.comments[i].time;
                user_comment.name = moment.comments[i].first_name + ' ' + moment.comments[i].last_name;
                user_comment.content = moment.comments[i].contents;
          ...
          pageObj.setState({trainingSessions:moments_info});          
        });
      }
    }, getDBdata, pageObj);
