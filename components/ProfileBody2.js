...
class ProfileBody extends Component {
    constructor(props) {
        ...
        // 获取personal info并保存
        //-------------如遇到页面不更新的问题，建议在componentDidMount()中发请求,不需要设置this-----------------------------
        ...
        //             //asdfasdfsdfsdfsadfasdfsadfsadfasdfdsfsadfasdfsdfsadfsdadfas
        ...
        //           });
        //           // 测试是否已成功存入state
        //           // alert(this.state.total_distance);
        ...
        //           }
        //           this.setState({trainingSessions: user_running_records})
        //           // 测试是否已成功存入state
        //           //alert(JSON.stringify(this.state.running_records[0]));

        //         }
        //       }
        //     })
        //   }}, storeinfo, opDBdata, this);
          ...
          totalSessions:4,
          trainingSessions:[
            {totalDistance:'None',avgSpeed:'None',dateOfCompletion:'None',mapImage:require('../assets/map1.png')}
          ]
        }
    }
    ...
    componentDidMount() {
      ...
      this.setState({postSessionEditor:false,currentSessionId:'123',newPostContent:'',sendingRequest:false});
      ...
      // this.setState({
      //   trainingSessions: [{id:'111a',totalDistance:'None',avgSpeed:'None',dateOfCompletion:'None',mapImage:require('../assets/map1.png')},
      //   {id:'112a',totalDistance:'None',avgSpeed:'None',dateOfCompletion:'None',mapImage:require('../assets/map1.png')},
      //   {id:'113a',totalDistance:'None',avgSpeed:'None',dateOfCompletion:'None',mapImage:require('../assets/map1.png')},
      //   {id:'114a',totalDistance:'None',avgSpeed:'None',dateOfCompletion:'None',mapImage:require('../assets/map1.png')}],
      //   profile_image:require("../assets/runningguys-v1.png"),
      //   first_name:'Name'
      // }) 
    }
    ...
    RenderSessions(props) {
      ...
      if (postId) {
        ...
        console.log(context.state.trainingSessions[0])
      }
        ...
        <View>
          {
            trainingSessions.map((value,i)=>{
              return (
                <TouchableOpacity onPress={()=>context.setState({postSessionEditor:true,currentSessionId:context.state.trainingSessions[i].id},()=>console.log("succ"))} style={styles.mainTab} key={i}>
                      <View style={{flex:2}}>
                        <Text style={styles.sessionTitleLarge}>Record {trainingSessions[i].id}</Text>
    ...
    render= (props) => {
      ...
      return (
        <View style={styles.body}>
            ...
            <Ionicons onPress={this.logOut.bind(this)} style={{position:'absolute',right:10}} name="md-exit" size={30} color="white" />
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <View style={{alignItems:'flex-start'}}  >
                  ...
                  />
                  <FontAwesome onPress={()=>this.submitPost()} style={this.state.sendingRequest ? styles.hide : styles.sendButton} name="send" size={26} color="rgba(74, 74, 74, 0.9)" />
                  <ActivityIndicator 
