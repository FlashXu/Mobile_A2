...
* Installing react native, please run:  `npm install -g react-native-cli`.  
* Installing expo, please run:  `npm install -g expo-cli`.
* Installing dependencies, please locate to the app file and run:  `npm install`.
